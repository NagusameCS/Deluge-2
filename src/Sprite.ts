...
export const DEFAULT_PLAYER_SPRITE: SpriteData = {
    ...
    pixels: [
        ['transparent', 'transparent', '#4af', '#4af', '#4af', '#4af', 'transparent', 'transparent'],
        ['transparent', '#4af', '#fea', '#fea', '#fea', '#fea', '#4af', 'transparent'],
        ['transparent', '#4af', '#fea', '#000', '#000', '#fea', '#4af', 'transparent'],
        ['transparent', 'transparent', '#fea', '#fea', '#fea', '#fea', 'transparent', 'transparent'],
        ['transparent', '#4af', '#4af', '#4af', '#4af', '#4af', '#4af', 'transparent'],
        ['transparent', 'transparent', '#4af', '#4af', '#4af', '#4af', 'transparent', 'transparent'],
        ['transparent', 'transparent', '#4af', 'transparent', 'transparent', '#4af', 'transparent', 'transparent'],
        ['transparent', 'transparent', '#642', 'transparent', 'transparent', '#642', 'transparent', 'transparent'],
    ],
    color: '#4af',
    char: '@',
    stats: {
...
export const WARRIOR_SPRITE: SpriteData = {
    ...
    pixels: [
        ['transparent', '#888', '#888', '#888', '#888', '#888', '#888', 'transparent'],
        ['transparent', '#888', '#fea', '#fea', '#fea', '#fea', '#888', 'transparent'],
        ['transparent', '#888', '#fea', '#000', '#000', '#fea', '#888', 'transparent'],
        ['transparent', 'transparent', '#fea', '#fea', '#fea', '#fea', 'transparent', 'transparent'],
        ['#ccc', '#a00', '#a00', '#a00', '#a00', '#a00', '#a00', '#ccc'],
        ['transparent', '#a00', '#a00', '#a00', '#a00', '#a00', '#a00', 'transparent'],
        ['transparent', 'transparent', '#666', 'transparent', 'transparent', '#666', 'transparent', 'transparent'],
        ['transparent', 'transparent', '#444', 'transparent', 'transparent', '#444', 'transparent', 'transparent'],
    ],
    color: '#a00',
    char: 'W',
    stats: {
...
export const MAGE_SPRITE: SpriteData = {
    ...
    pixels: [
        ['transparent', 'transparent', '#a0f', '#a0f', '#a0f', '#a0f', 'transparent', 'transparent'],
        ['transparent', '#a0f', '#fea', '#fea', '#fea', '#fea', '#a0f', 'transparent'],
        ['transparent', '#a0f', '#fea', '#a0f', '#a0f', '#fea', '#a0f', 'transparent'],
        ['transparent', 'transparent', '#fea', '#fea', '#fea', '#fea', 'transparent', 'transparent'],
        ['transparent', '#50a', '#50a', '#50a', '#50a', '#50a', '#50a', 'transparent'],
        ['transparent', '#50a', '#50a', '#50a', '#50a', '#50a', '#50a', 'transparent'],
        ['transparent', 'transparent', '#50a', '#50a', '#50a', '#50a', 'transparent', 'transparent'],
        ['transparent', 'transparent', '#432', 'transparent', 'transparent', '#432', 'transparent', 'transparent'],
    ],
    color: '#a0f',
    char: 'M',
    stats: {
...
export const ROGUE_SPRITE: SpriteData = {
    ...
    pixels: [
        ...
        ['transparent', '#333', '#fea', '#fea', '#fea', '#fea', '#333', 'transparent'],
        ['transparent', '#222', '#fea', '#000', '#000', '#fea', '#222', 'transparent'],
        ['transparent', 'transparent', '#fea', '#fea', '#fea', '#fea', 'transparent', 'transparent'],
        ['transparent', '#222', '#222', '#222', '#222', '#222', '#222', 'transparent'],
        ['transparent', 'transparent', '#222', '#222', '#222', '#222', 'transparent', 'transparent'],
        ['transparent', 'transparent', '#222', 'transparent', 'transparent', '#222', 'transparent', 'transparent'],
        ['transparent', 'transparent', '#111', 'transparent', 'transparent', '#111', 'transparent', 'transparent'],
    ],
    color: '#333',
    char: 'R',
    stats: {
